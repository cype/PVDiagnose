...
from test_efficiency import test_efficiency
...
# uberlandstrasse
print('\nÜberlandstrasse PV')
test_efficiency(Uberlandstrasse_size, Uberlandstrasse2d_erwartung, Uberlandstrasse2d_2018, months)

# batastrasse
print('\nBatastrasse PV')
test_efficiency(Batastrasse_size, Batastrasse40_erwartung, Batastrasse40_2018, months)

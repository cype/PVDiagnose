...
from efficiency import pv_efficiency
from matplotlib import pyplot as plt

import pandas as pd

def test_efficiency(area, expected_data, measured_data, months):
    ...
    print('efficiency =', pv_efficiency(area, expected_data, measured_data))
    ...
    print('efficiency =', pv_efficiency(1, expected_data_normalized, measured_data_normalized))
